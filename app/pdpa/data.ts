...
export const PDPC_ANNOUNCEMENTS = [
  { date: "ธ.ค. 2566 (มีผล มี.ค. 2567)", title: "ประกาศว่าด้วยการส่งข้อมูลข้ามประเทศ — Whitelist & BCR/Adequate Safeguards", topic: "Cross-Border Transfer" },
  { date: "ก.ย. 2566 (มีผล ธ.ค. 2566)", title: "ประกาศว่าด้วยการแต่งตั้งเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล (DPO)", topic: "DPO Designation" },
  { date: "ม.ค. 2567 (มีผล เม.ย. 2567)", title: "ประกาศว่าด้วยข้อมูลประวัติอาชญากรรม (Criminal Records)", topic: "Sensitive Data" },
  { date: "ส.ค. 2567 (มีผล พ.ย. 2567)", title: "ประกาศว่าด้วยการลบ ทำลาย และ Anonymize ข้อมูลส่วนบุคคล", topic: "Data Erasure" },
  { date: "ก.พ. 2568", title: "ประกาศ PDPC ว่าด้วยการแจ้งเหตุละเมิดข้อมูลส่วนบุคคล (Breach Notification 72 ชั่วโมง)", topic: "Breach Notification" },
  { date: "ต.ค. 2568", title: "ประกาศว่าด้วยการตรวจสอบและรับรองนโยบายในกลุ่มธุรกิจเดียวกัน (Group Policy Certification)", topic: "Group Policy" },
]
