...
import {
  ...
  Target, BarChart3, PieChart, Calendar, Plus,
} from "lucide-react"
import {
          ...
          <TabsContent value="compliance" className="space-y-6">
            <div className="grid gap-6 lg:grid-cols-2">
              <Card className="border-border bg-card">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-foreground text-sm">
                    <Shield className="h-4 w-4 text-primary" />AI Compliance Coverage
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-border bg-card">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-foreground text-sm">
                    <FileText className="h-4 w-4 text-primary" />Compliance Checklist
                  </CardTitle>
                </CardHeader>
